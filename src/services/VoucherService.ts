...
export class VoucherService {
    ...
    private async initEventListener() {
        const contractAddress = "0x0B021C6d74F2572e09Ea9a626e58A7b288ed1587"; // Địa chỉ contract của bạn
        const contractABI = [
        ...
        contract.on("VoucherTransferred", (tokenId, from, to) => {
            console.log(`🔄 VoucherTransferred | Token ID: ${tokenId}, From: ${from}, To: ${to}`);
        });
    }
