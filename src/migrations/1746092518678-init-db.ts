...
export class InitDb1746092518678 implements MigrationInterface {
    name = 'InitDb1746092518678'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "voucher" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "denominationId" integer NOT NULL, "ownerId" character varying NOT NULL, "status" "public"."voucher_status_enum" NOT NULL DEFAULT 'READY', "expiredAt" TIMESTAMP, "redeemedAt" TIMESTAMP, "tokenId" integer NOT NULL, CONSTRAINT "PK_677ae75f380e81c2f103a57ffaf" PRIMARY KEY ("id"))`);
