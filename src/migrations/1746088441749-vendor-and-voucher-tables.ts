...
export class VendorAndVoucherTables1746088441749 implements MigrationInterface {
    name = 'VendorAndVoucherTables1746088441749'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "voucher" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "denominationId" integer NOT NULL, "ownerId" character varying NOT NULL, "status" "public"."voucher_status_enum" NOT NULL DEFAULT 'READY', "expiredAt" TIMESTAMP, "redeemedAt" TIMESTAMP, CONSTRAINT "PK_677ae75f380e81c2f103a57ffaf" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "voucher" ADD CONSTRAINT "FK_44fb18d8837f86f14cd7597544c" FOREIGN KEY ("ownerId") REFERENCES "user"("walletAddress") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
